...
\begin{figure}[t]
	...
	\caption{During the sleeping activity the data from both sensors remains constant for large time spans. The capacitive sensor shows the coverage of the arm with either cushions, blankets or the proximity to the mattress, the head or body of the participant.}
	\label{fig:sleeping}
\end{figure}
